...
const descriptions = {
  ...
  proofreading: "Подсвечивает вероятные орфографические и пунктуационные ошибки до финальной вычитки."
};
const modules = [
  ...
  { id: "proofreading", title: "Предпроверка текста", enabled: false }
];
const metricTitles = [
  "Время до регистрации документа",
  "Охват документооборота тероргана",
  "Ошибки, замеченные на предпроверке",
